...
app.get("/", (req, res) =>
    res.sendFile(path.join(clientDir, "login_register.html")),
);
...
app.post("/api/chat", async (req, res) => {
    ...
    const apiKey =
        process.env.MISTRAL_API_KEY || "w6wS2RXI8f2I1IjbDB9FEaTR1PWCFayq";
    const agentId =
        process.env.AGENT_ID || "ag_019c9025025775f792f2f5f444aec7b3";
    try {
